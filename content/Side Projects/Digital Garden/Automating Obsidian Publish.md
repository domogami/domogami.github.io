...
Because [Raycast](../../Software/Raycast.md) does not support the ability to prompt the user for inputs mid-execution, I decided to make two separate scripts. The first script exports my obsidian vault, builds the quartz site, and then lists the diffed files to ensure that there are no unintended additions. 
